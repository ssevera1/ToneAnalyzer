...
C4Component
    ...
    Container_Boundary(spa, "React SPA") {
        ...
        Component_Boundary(emotionFeature, "Emotion Detection Feature") {
            Component(emotionPage, "EmotionMonitorPage", "React Page", "Grid layout selector, video panels, add source controls")
        ...
        Component_Boundary(stores, "State Management (Zustand)") {
            ...
            Component(emotionStore, "useEmotionStore", "Zustand Store", "Active video sources, emotion readings per source, monitoring sessions, grid layout")
        }
        ...
        Component_Boundary(services, "Services") {
            ...
            Component(exportService, "ExportService", "TypeScript", "CSV (PapaParse) and PDF (jsPDF) generation for voice and emotion data")
...
sequenceDiagram
    ...
    loop Every 100ms (10 FPS, round-robin across feeds)
        ...
        EA-->>Hook: ExpressionLabels[] + primeEmotion
